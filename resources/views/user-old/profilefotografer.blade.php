...
<<head>
    ...
    <style>
        ...
        .card {
            ...
            height: 100%;
            /* Atur tinggi maksimum card */
        }

        .card-img-container {
            height: 200px;
            /* Atur tinggi maksimum container gambar */
            overflow: hidden;
        ...
        .card-img {
            width: 100%;
            /* Gambar akan mengisi lebar container */
            height: 100%;
            /* Tinggi gambar akan mengisi container */
            object-fit: cover;
            /* Memastikan gambar tetap proporsional dan mengisi container sepenuhnya */
        }
    ...
    <body>
        ...
        <div class="container">
            <div class="row mt-3">
                <div class="row mt-5 mb-5">
                    ...
                    <div class="col-6">
                        <div class="content-card">
                            <div class="content-title">Profile Fotografer</div>
                        </div>
                    </div>
                    <div class="col"></div>
                </div>
                ...
                <div class="row mt-3">
                    <!-- Card Example 1 -->
                    @foreach ($data as $fotografers)
                    <div class="col-md-4 mb-4">
                        <div class="card">
                            <div class="card-img-container">
                                <img src="{{ asset('images/'.$fotografers->foto) }}" alt="foto" class="card-img">
                            </div>
                            <div class="card-body">
                                <p class="card-title">{{ $fotografers->nama }}</p>
                                <p class="card-subtitle">{{ $fotografers->pengalaman }}</p>
                            </div>
                        </div>
                    </div>
                    @endforeach
