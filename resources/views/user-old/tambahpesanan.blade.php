            ...
            <div class="col d-flex justify-content-center">
                <div class="form-card mt-4" style="width: 800px">
                    <div class="card-body">
                        ...
                        <form action="{{ route('postTambahPesanan') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="form-group mt-4">
                                <label class="text-secondary mb-2">Nama Pelangan</label>
                            ...
                            <div class="form-group mt-1">
                                <label class="text-secondary mb-2">Jenis Paket</label>
                                <select class="form-select" arialabel="Floating label select example" name="idPaket"
                                    required value="{{old('idPaket') }}">
                                    <option value="Programmer" selected>Paket Wedding</option>
                                    <option value="Sains">Paket Prewedding</option>
                                    <option value="Komik">Paket Tunangan</option>
                                </select>
                            </div><br>
                            <div class="form-group mt-1">
